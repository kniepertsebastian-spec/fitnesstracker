...
Aktueller Stand (Phasen 0–5 + 8–11 + 14 – Foundation, Übungsbibliothek, Trainingsplan-Rotation,
Ziele, Offline-Sync, Push, Ernährungsrechner, Wasser-Tracking, Supplement-Erinnerungen,
Körperkomposition-Tracking & Tages-Challenge): Login/Registrierung, die Trainings-Tabelle
...
Wasseranteil mit Trend-Anzeige) und eine tägliche Bodyweight-Challenge (3 Zufallsübungen ohne
Geräte, aus dem importierten Katalog) sind Ende-zu-Ende lauffähig. Die Übungs-API liefert dafür
volle CRUD-Verwaltung plus einen Import-Mechanismus, der Übungen aus externen, frei verfügbaren
Datenbanken zieht und in die eigene DB schreibt (siehe unten). Claude-API-Integration ist als
Datenmodell bereits angelegt, aber noch ohne UI; weitere Phasen (Fortschritts-Fotos, automatische
